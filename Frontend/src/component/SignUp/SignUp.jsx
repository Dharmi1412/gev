    ...
    return (
        <div className='signup-main'>
            <div className='signup-div'>
                <img src="https://evindia.online/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fsignup-web.341a4273.jpg&w=1080&q=75" alt="" />
            </div>
            <div className='signup2-div'>
                ...
                <div className='signup-input'>
                    <div className=''><label>User name</label></div>
                    <div>
                        <input
                            type="text"
                            name="userName"
                ...
                <div className='flagimg-div signup-input'>
                    ...
                    <div className='number-div'>
                        <div><img src={assets.flagimg} alt="" /> </div>
                        <div>
                            +91
                            <input
                                type="text"
                ...
                <div className='signup-input'>
                    <div className=''><label htmlFor="">E-mail</label></div>
                    <div>
                        <input
                            type="text"
                            name="email"
                ...
                <div className='signup-input chechbox-div'>
                    ...
                    <div><p>I agree to terms & condition</p></div>
                </div>
                <div className='signup-input'>
